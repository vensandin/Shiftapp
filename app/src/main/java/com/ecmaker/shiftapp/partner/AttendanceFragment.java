...
public class AttendanceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getWorkingView(inflater, container, root, mainActivity);

        return root;
    }

    //畫班表
    public void getWorkingView(LayoutInflater inflater, ViewGroup container, View workingView, MainActivity mainActivity){
